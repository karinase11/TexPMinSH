...
\clearpage
\subsection{Eventlogs generieren}\label{lst:generate}
...
\clearpage
\subsection{Eventlogs nach XES Parsen}
\begin{lstlisting}[language=Python]
...
\clearpage
\subsection{Konfiguration der Versuchsreihen}
Eingabedaten für den Eventloggenerator.
Je Versuchsreihe wurden vier Eventlogs generiert, die jeweils Zeilen der Schemata 'A' - 'M' enthielten.\begin{table}[]
\centering
...
\clearpage
\section{Hausautomatisierung durch Regelerkennung}
