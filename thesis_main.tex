...
\documentclass[12pt, a4paper, BCOR=10mm, english, ngerman]{scrbook}
...
\begin{document}
   ...
   % \listofalgorithms
    ...
    \pagestyle{fancy}
%    \include{chapters/0_3-abk_Verzeichnis}
    \include{chapters/1-einleitung}
    \include{chapters/2-grundlagen}
    \include{chapters/3-stand-technik}
    \include{chapters/4-vergleich-miner}
    \include{chapters/6-anwendung}
    \include{chapters/8-auswertung}
    \include{chapters/9-Anhang}
